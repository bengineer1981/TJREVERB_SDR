...
# Title: Aprs Rxtx
# Generated: Mon Dec 17 17:48:39 2018
##################################################
...
class aprs_rxtx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.bruninga_ax25_fsk_mod_0 = bruninga.ax25_fsk_mod(samp_rate, 300, 10, 2200, 1200, 1200)
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink('/home/ben-mccall/Desktop/flowgraphs/TJ_APRS/afsk_audio_files/gr_bruninga_helloworld2.wav', 1, samp_rate, 16)
        self.blocks_socket_pdu_0 = blocks.socket_pdu("UDP_SERVER", '', '5577', 10000, False)
...
def main(top_block_cls=aprs_rxtx, options=None):
