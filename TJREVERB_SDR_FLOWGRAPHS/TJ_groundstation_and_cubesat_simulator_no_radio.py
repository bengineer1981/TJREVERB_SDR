...
class TJ_groundstation_and_cubesat_simulator_no_radio(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "TJ Groundstation and Cubesat Simulator (no radio)")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("TJ Groundstation and Cubesat Simulator (no radio)")
        ...
        self.settings = Qt.QSettings("GNU Radio", "TJ_groundstation_and_cubesat_simulator_no_radio")
        ...
        self.max_msg_len = max_msg_len = 58
        self.hdr_len = hdr_len = 67
        self.freq = freq = freq_chooser
        self.cubesat_sim_port_4 = cubesat_sim_port_4 = "5558"
        self.cubesat_sim_port_3 = cubesat_sim_port_3 = "5557"
        self.cubesat_sim_port_2 = cubesat_sim_port_2 = "5556"
        self.cubesat_sim_port_1 = cubesat_sim_port_1 = "5555"
        self.cubesat_ip_addr = cubesat_ip_addr = "127.0.0.1"
        self.channel_noise = channel_noise = 0
        self.channel_freq_offset = channel_freq_offset = 0
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._channel_noise_range = Range(0, 1, 0.01, 0, 200)
        self._channel_noise_win = RangeWidget(self._channel_noise_range, self.set_channel_noise, "channel noise", "counter_slider", float)
        self.top_grid_layout.addWidget(self._channel_noise_win)
        self._channel_freq_offset_range = Range(0, 1, 0.01, 0, 200)
        self._channel_freq_offset_win = RangeWidget(self._channel_freq_offset_range, self.set_channel_freq_offset, "channel freq offset", "counter_slider", float)
        self.top_grid_layout.addWidget(self._channel_freq_offset_win)
        ...
        self.channels_channel_model_0_0 = channels.channel_model(
        	...
        	frequency_offset=channel_freq_offset,
        	epsilon=1.0,
        	taps=(1.0 + 1.0j, ),
        	noise_seed=0,
        	block_tags=False
        ...
        self.blocks_udp_sink_0_0 = blocks.udp_sink(gr.sizeof_char*1, cubesat_ip_addr, int(cubesat_sim_port_3), 1472, True)
        self.blocks_udp_sink_0 = blocks.udp_sink(gr.sizeof_char*1, cubesat_ip_addr, int(cubesat_sim_port_2), 1472, False)
        self.blocks_throttle_1 = blocks.throttle(gr.sizeof_gr_complex*1, 1e6,True)
        self.blocks_sub_xx_0_0_0_0 = blocks.sub_ff(1)
        self.blocks_sub_xx_0_0_0 = blocks.sub_ff(1)
        self.blocks_socket_pdu_0_0_0 = blocks.socket_pdu("UDP_SERVER", cubesat_ip_addr, cubesat_sim_port_4, 10000, False)
        self.blocks_socket_pdu_0_0 = blocks.socket_pdu("UDP_SERVER", cubesat_ip_addr, cubesat_sim_port_1, 10000, False)
        ...
        self.connect((self.analog_nbfm_rx_0, 0), (self.qtgui_time_sink_x_0, 0))
        ...
        self.connect((self.blocks_throttle_1, 0), (self.channels_channel_model_0_0, 0))
        ...
        self.connect((self.bruninga_ax25_fsk_mod_0_0, 0), (self.qtgui_time_sink_x_0_2, 0))
        ...
        self.connect((self.rational_resampler_xxx_0_0, 0), (self.channels_channel_model_0, 0))
        ...
        self.connect((self.rational_resampler_xxx_0_0_0, 0), (self.blocks_throttle_1, 0))
        self.connect((self.rational_resampler_xxx_0_0_0, 0), (self.qtgui_freq_sink_x_0_1_1_0, 0))
        self.connect((self.rational_resampler_xxx_0_0_0, 0), (self.qtgui_waterfall_sink_x_0_2_0, 0))
    ...
    def set_audio_rate(self, audio_rate):
        ...
        self.set_rf_tx_rate(self.audio_rate*self.interp)
        self.qtgui_waterfall_sink_x_0_2_0.set_frequency_range(self.freq, self.audio_rate)
        self.qtgui_waterfall_sink_x_0_2.set_frequency_range(self.freq, self.audio_rate)
        self.qtgui_waterfall_sink_x_0_1.set_frequency_range(self.freq, self.audio_rate)
        self.qtgui_waterfall_sink_x_0.set_frequency_range(self.freq, self.audio_rate)
        ...
        self.qtgui_freq_sink_x_0_2.set_frequency_range(self.freq, self.audio_rate)
        self.qtgui_freq_sink_x_0_1_1_0.set_frequency_range(self.freq, self.audio_rate)
        self.qtgui_freq_sink_x_0_1_1.set_frequency_range(self.freq, self.audio_rate)
        self.qtgui_freq_sink_x_0.set_frequency_range(self.freq, self.audio_rate)
    ...
    def set_max_msg_len(self, max_msg_len):
    ...
    def get_cubesat_sim_port_4(self):
        return self.cubesat_sim_port_4

    def set_cubesat_sim_port_4(self, cubesat_sim_port_4):
        self.cubesat_sim_port_4 = cubesat_sim_port_4

    def get_cubesat_sim_port_3(self):
        return self.cubesat_sim_port_3

    def set_cubesat_sim_port_3(self, cubesat_sim_port_3):
        self.cubesat_sim_port_3 = cubesat_sim_port_3

    def get_cubesat_sim_port_2(self):
        return self.cubesat_sim_port_2

    def set_cubesat_sim_port_2(self, cubesat_sim_port_2):
        self.cubesat_sim_port_2 = cubesat_sim_port_2

    def get_cubesat_sim_port_1(self):
        return self.cubesat_sim_port_1

    def set_cubesat_sim_port_1(self, cubesat_sim_port_1):
        self.cubesat_sim_port_1 = cubesat_sim_port_1
    ...
    def set_channel_freq_offset(self, channel_freq_offset):
        ...
        self.channels_channel_model_0_0.set_frequency_offset(self.channel_freq_offset)
        self.channels_channel_model_0.set_frequency_offset(self.channel_freq_offset)
...
def main(top_block_cls=TJ_groundstation_and_cubesat_simulator_no_radio, options=None):
