...
# Generated: Fri Jan 25 18:51:30 2019
##################################################
...
class TJ_cubesat_UHD_param_cntrl_for_no_gui_with_IQ_streaming(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.zeromq_pull_source_0_0_0_0 = zeromq.pull_source(gr.sizeof_float, 1, "tcp://"+cubesat_ip_addr+":"+cubesat_zmq_port_4, 100, False, -1)
        ...
        self.xmlrpc_client1_0_0_0 = xmlrpclib.Server('http://10.0.0.54:1234')
        self.xmlrpc_client1_0_0 = xmlrpclib.Server('http://10.0.0.54:1234')
        self.xmlrpc_client1_0 = xmlrpclib.Server('http://10.0.0.54:1234')
        self.xmlrpc_client1 = xmlrpclib.Server('http://10.0.0.54:1234')
    ...
    def set_tx_gain(self, tx_gain):
        ...
        self.xmlrpc_client1_0.set_tx_gain(self.tx_gain)
    ...
    def set_gain(self, gain):
        self.gain = gain
        self.xmlrpc_client1.set_gain(self.gain)
    ...
    def set_freq(self, freq):
        self.freq = freq
        self.xmlrpc_client1_0_0.set_freq(self.freq)
    ...
    def set_audio_line_driver(self, audio_line_driver):
        ...
        self.xmlrpc_client1_0_0_0.set_audio_line_driver(self.audio_line_driver)
