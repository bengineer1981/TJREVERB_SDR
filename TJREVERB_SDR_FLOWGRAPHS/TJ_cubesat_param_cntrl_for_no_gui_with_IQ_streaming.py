...
# Generated: Sun Feb  3 19:42:51 2019
##################################################
...
class TJ_cubesat_param_cntrl_for_no_gui_with_IQ_streaming(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("TJ Cubesat Parameter Control (no GUI with IQ Streaming)")
        ...
        self.xmlrpc_client1_0_0_1 = xmlrpclib.Server('http://192.168.1.10:1234')
        self.xmlrpc_client1_0_0_0_0 = xmlrpclib.Server('http://192.168.1.10:1234')
