...
class TJ_UHD_dev_modem(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.ack_len = ack_len = hdr_len+16
        ...
        self.blocks_tagged_stream_to_pdu_1_0 = blocks.tagged_stream_to_pdu(blocks.byte_t, 'packet_len')
        self.blocks_sub_xx_0_0_0_0 = blocks.sub_ff(1)
        self.blocks_stream_to_tagged_stream_0_0 = blocks.stream_to_tagged_stream(gr.sizeof_char, 1, hdr_len+max_msg_len+tail_len, "packet_len")
        self.blocks_socket_pdu_0 = blocks.socket_pdu("TCP_SERVER", '', str(5557), max_msg_len+hdr_len+tail_len, False)
        ...
        self.connect((self.blocks_stream_to_tagged_stream_0_0, 0), (self.blocks_tagged_stream_to_pdu_1_0, 0))
    ...
    def set_hdr_len(self, hdr_len):
        ...
        self.blocks_stream_to_tagged_stream_0_0.set_packet_len(self.hdr_len+self.max_msg_len+self.tail_len)
        self.blocks_stream_to_tagged_stream_0_0.set_packet_len_pmt(self.hdr_len+self.max_msg_len+self.tail_len)
        self.set_ack_len(self.hdr_len+16)
    ...
    def get_ack_len(self):
        return self.ack_len

    def set_ack_len(self, ack_len):
