...
# Generated: Fri Feb  1 17:17:42 2019
##################################################
...
class TJ_UHD_dev_modem(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "TJ_UHD_dev_modem")
        ...
        self.blocks_throttle_1 = blocks.throttle(gr.sizeof_gr_complex*1, rf_rx_rate,True)
    ...
    def set_rf_rx_rate(self, rf_rx_rate):
        ...
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.rf_rx_rate, self.rx_downsamp_bw/2, 1000, firdes.WIN_HAMMING, 6.76))
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.rf_rx_rate, self.rx_downsamp_bw/2, 1000, firdes.WIN_HAMMING, 6.76))
        self.blocks_throttle_1.set_sample_rate(self.rf_rx_rate)
...
def main(top_block_cls=TJ_UHD_dev_modem, options=None):
