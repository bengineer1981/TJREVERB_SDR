...
# Generated: Wed Feb  6 00:34:18 2019
##################################################
...
class TJ_cubesat_nogui_with_cntrl_and_IQ_streaming_autorun(gr.top_block):
...
def main(top_block_cls=TJ_cubesat_nogui_with_cntrl_and_IQ_streaming_autorun, options=None):
