...
class TJ_cubesat_UHD_nogui(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "TJ Cubesat UHD No Gui")
...
def main(top_block_cls=TJ_cubesat_UHD_nogui, options=None):
