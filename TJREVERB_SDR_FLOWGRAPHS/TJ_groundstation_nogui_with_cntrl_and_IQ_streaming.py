...
# Generated: Wed Feb  6 03:08:56 2019
##################################################
...
class TJ_groundstation_nogui_with_cntrl_and_IQ_streaming(gr.top_block):
...
def main(top_block_cls=TJ_groundstation_nogui_with_cntrl_and_IQ_streaming, options=None):
